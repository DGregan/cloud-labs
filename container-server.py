...
def images_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/images | python -msjon.tool
    """
    docker ('rmi', id)
    resp = '{"id": "%s"}' % id
    return Response(response=resp, mimetype="application/json")
...
def containers_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/<id> | python -msjon.tool
...
def containers_remove_all():
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers | python -msjon.tool
